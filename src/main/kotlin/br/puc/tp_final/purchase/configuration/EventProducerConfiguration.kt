...
class EventProducerConfiguration {
    ...
    @Bean(USER_RELATIONS_QUEUE)
    fun relationsDepartmentQueue(): Queue {
        return Queue(USER_RELATIONS_QUEUE, true)
    }
    ...
    @Bean
    fun userRelations(@Qualifier(USER_RELATIONS_QUEUE) queue: Queue, eventExchange: TopicExchange): Binding {
